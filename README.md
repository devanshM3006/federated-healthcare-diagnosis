...
Each client performs local model training while the federated server aggregates model updates into a global model.

This project demonstrates that workflow across multiple heterogeneous healthcare prediction tasks.
